    ...
    <div class="row mt-1 mx-auto">
        <div class="col-lg-6 p-3 my-3 border">
            ...
            <form action="" method="GET" class="">
                <ul class="pt-5">
                    <li type="none">
                        <select name="col" class="btn btn-outline-secondary" id="">
                            <option value="loai_phong.tenloaiphong">Loại phòng</option>
                            <option value="phong.sophong">Số phòng</option>
                            <option value="tang.sotang">Tầng</option>
                        </select>
                    </li>
            ...
            <div class="col-lg-6 p-3 my-3 border">
                <div class="text-center">Tổng tiền phòng: <?=formatNumber($tongtienphong)?> VND</div>
