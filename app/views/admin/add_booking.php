    ...
    <div class="container-fluid">
        <form action="" method="post">
            <div class="form-group mt-3">
                ...
                <input type="text" name='id' id="id" class="form-control" required disabled>
            </div>
            <div class="form-group mt-3">
            ...
            <div class="form-group mt-3">
                ...
                <input type="text" name='trangthaidat' id="trangthaidat" class="form-control" disabled required>
            </div>
            <div class="form-group mt-3">
                <label for="trangthaitt">Trạng thái thanh toán:</label>
                <input type="text" name='trangthaitt' id="trangthaitt" class="form-control" disabled required>
            </div>
            <div class="mt-5 d-flex align-items-center">
                <button type="submit" id="btnThem" class="btn btn-success mx-auto">thêm phòng đặt</button>
